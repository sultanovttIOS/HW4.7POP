...
class VisaViewController: UIViewController, TransferProtocol {

    private var isRequisiteValid: Bool = false
    private var isSumValid: Bool = false
    private let myBalance = 1000.0
    
    private lazy var requisiteTF = MakerView.shared.makerTf(placeholder: "Введите номер карты", cornerRadius: 12,
                                                            backgroundColor: .white)
    
    private lazy var sumTF = MakerView.shared.makerTf(placeholder: "Введите сумму", cornerRadius: 12,
                                                      backgroundColor: .white)
    ...
    private lazy var recipientBalanceLabel = MakerView.shared.makerLabel(text: "Баланс: 1000.0 сом",
                                                                         font: UIFont.systemFont(ofSize: 20, weight: .semibold), textColor: .black, numberOfLines: 2)
